...
enum AppStrings {
    private static let packagedResourceBundleName = "Fovea_FoveaApp"
    ...
    static let settingsKeys = [
        ...
        "settings.fileAssociations.defaultFovea", "settings.fileAssociations.defaultOther",
    ...
    static let interactionKeys = [
        ...
        "viewer.rename.title", "viewer.rename.message", "viewer.rename.button", "viewer.rename.cancel",
        "viewer.error.unsupportedFormat", "viewer.error.decodeFailed",
        "viewer.error.trashFailed", "viewer.error.renameFailed",
        "viewer.error.applyEditFailed", "viewer.error.saveFailed",
        "viewer.error.saveAsFailed", "viewer.error.discardFailed",
        "viewer.error.externallyModified", "viewer.error.externallyModifiedDecodeFailed",
        "viewer.error.externallyRemoved",
        "viewer.error.externallyRemovedWithUnsavedEdits",
        "viewer.title.edited",
