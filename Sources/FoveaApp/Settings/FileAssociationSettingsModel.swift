...
final class FileAssociationSettingsModel: ObservableObject {
    ...
    func refreshStatuses() {
        let fovea = bundleResolver.validatedRunningApplication(at: applicationURL())
        for format in Self.allFormats {
            ...
            rows[format] = FileAssociationRowState(
                ...
                isFoveaDefault: Self.isSameApplication(fovea, defaultApplication),
