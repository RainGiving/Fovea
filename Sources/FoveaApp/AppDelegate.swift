...
final class AppDelegate: NSObject, NSApplicationDelegate {
    private static let openRecentMenuItemIdentifier = NSUserInterfaceItemIdentifier("Fovea.openRecent")
    private static let appearanceMenuItemIdentifierPrefix = "Fovea.appearance."
    ...
    func configureHelpMenuSearchSuppression() {
        NSApp.helpMenu = NSMenu(title: "FoveaHelpSearch")
    }
    ...
    func makeMainMenu(preferredLanguages: [String] = Locale.preferredLanguages) -> NSMenu {
        ...
        let appMenuItem = NSMenuItem(title: "Fovea", action: nil, keyEquivalent: "")
        mainMenu.addItem(appMenuItem)
        let appMenu = NSMenu(title: "Fovea")
        ...
        let helpItem = NSMenuItem(title: text("menu.help.fovea"), action: #selector(showHelp(_:)), keyEquivalent: "?")
