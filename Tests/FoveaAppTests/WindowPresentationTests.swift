...
final class WindowPresentationTests: XCTestCase {
    ...
    func testEmptyAndErrorModesKeepTheCanvasBehindThem() {
        let empty = WindowPresentation.resolve(WindowPresentation.Input(mode: .empty, viewerTitle: "Fovea"))
        ...
        let error = WindowPresentation.resolve(WindowPresentation.Input(mode: .error, viewerTitle: "Fovea"))
        XCTAssertTrue(error.showsErrorState)
        XCTAssertFalse(error.showsEmptyState)

        let loading = WindowPresentation.resolve(WindowPresentation.Input(mode: .loading, viewerTitle: "Fovea"))
