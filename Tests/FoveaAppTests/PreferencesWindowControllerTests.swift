...
final class PreferencesWindowControllerTests: XCTestCase {
    ...
    func testApplyButtonStartsDisabled() throws {
        ...
        XCTAssertEqual(button.title, "Set Fovea as Default")
    }
...
private func makeController(
    ...
    return PreferencesWindowController(
        ...
        applicationURL: { URL(fileURLWithPath: "/Applications/Fovea.app") },
...
private final class ControllerBundleResolver: ApplicationBundleResolving {
    private let info = ApplicationBundleInfo(
        url: URL(fileURLWithPath: "/Applications/Fovea.app"),
