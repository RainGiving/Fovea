...
final class AppStringsTests: XCTestCase {
    func testFileAssociationSettingsLocalizeInEnglishAndSimplifiedChinese() {
        ...
        XCTAssertEqual(AppStrings.text("settings.fileAssociations.apply", preferredLanguages: ["en"]), "Set Fovea as Default")
        XCTAssertEqual(AppStrings.text("settings.fileAssociations.title", preferredLanguages: ["zh-Hans"]), "文件关联")
        XCTAssertEqual(AppStrings.text("settings.fileAssociations.apply", preferredLanguages: ["zh-Hans"]), "将 Fovea 设为默认")
    }
