...
final class ApplicationBundleResolverTests: XCTestCase {
    func testRejectsNilNonexistentAndOrdinaryAppDirectory() throws {
        ...
        let resolver = BundleApplicationResolver(currentExecutableURL: { root.appendingPathComponent("Fovea") })
    ...
    func testRejectsBundleThatDoesNotContainCurrentExecutable() throws {
        ...
        let resolver = BundleApplicationResolver(currentExecutableURL: { root.appendingPathComponent("Elsewhere/Fovea") })
